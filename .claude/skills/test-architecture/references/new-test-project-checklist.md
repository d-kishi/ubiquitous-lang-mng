...
- [Phase 1: 事前確認](#phase-1-事前確認)
- [Phase 2: プロジェクト作成](#phase-2-プロジェクト作成)
- [Phase 3: 参照関係設定](#phase-3-参照関係設定)
- [Phase 4: NuGetパッケージ追加](#phase-4-nugetパッケージ追加)
- [Phase 5: ビルド・実行確認](#phase-5-ビルド実行確認)
- [Phase 6: Issue #40再発防止](#phase-6-issue-40再発防止)
- [Phase 7: ドキュメント更新](#phase-7-ドキュメント更新)
- [最終確認](#最終確認)
