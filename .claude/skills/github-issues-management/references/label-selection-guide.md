...
- [ラベル選択の3段階プロセス](#-ラベル選択の3段階プロセス)
- [種別ラベル判断（必須・1つ選択）](#1️⃣-種別ラベル判断必須1つ選択)
- [優先度ラベル判断（必須・1つ選択）](#2️⃣-優先度ラベル判断必須1つ選択)
- [影響範囲ラベル判断（任意・複数選択可）](#3️⃣-影響範囲ラベル判断任意複数選択可)
- [ラベル組み合わせパターン（よくある例）](#-ラベル組み合わせパターンよくある例)
- [注意事項](#️-注意事項)
