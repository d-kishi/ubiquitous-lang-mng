...
- [概要](#概要)
- [パターン1: IsOkプロパティ直接アクセス（推奨）](#パターン1-isokプロパティ直接アクセス推奨)
- [パターン2: C#からF# Result型を生成](#パターン2-cからf-result型を生成)
- [パターン3: Railway-oriented Programming統合](#パターン3-railway-oriented-programming統合)
