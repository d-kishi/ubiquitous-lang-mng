...
- **ADR_024**: E2E専用SubAgent新設決定（e2e-test Agent責務定義）
- **.claude/skills/subagent-patterns/**: 14種類のSubAgent定義・責務境界
- **.claude/skills/playwright-e2e-patterns/**: e2e-test Agent専用・3つのE2Eテストパターン
