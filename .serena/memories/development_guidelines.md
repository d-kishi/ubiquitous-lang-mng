...
## 🔴 プロセス遵守絶対原則（2025-12-07強化）

**原則**: コマンド=契約、承認=必須、手順=聖域（違反は一切許容されない）

**強化**: Project-Specific Constitution追加（4条構成・CLAUDE.md冒頭）
- 第1条: プロセス不可侵の原則
- 第2条: 承認絶対主義
- 第3条: 実体主義
- 第4条: 効率化バイアスの自己認識

**例**: 承認前の作業開始禁止・成果物の虚偽報告禁止・LLM効率化バイアス対策

**詳細**: `CLAUDE.md` - Project-Specific Constitution + ADR_016プロセス遵守絶対原則 参照
