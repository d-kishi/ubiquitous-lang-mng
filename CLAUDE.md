...
**詳細**: `.claude/rules/core/project-constitution.md`

---

## 🔴 CRITICAL: プロセス遵守絶対原則（ADR_016）

**詳細**: `.claude/rules/core/process-compliance.md`

## 🤝 CRITICAL: コミュニケーション原則

**詳細**: `.claude/rules/core/communication-principles.md`
...
**詳細**: `.claude/rules/core/session-continuity.md`
...
3. **新規プロジェクト作成チェックリスト**: `/Doc/08_Organization/Guide/新規テストプロジェクト作成ガイドライン.md`
...
**詳細**: `.claude/rules/operations/organization-manual.md` - Context管理セクション
