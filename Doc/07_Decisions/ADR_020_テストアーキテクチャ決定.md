...
└── UbiquitousLanguageManager.E2E.Tests/                      # TypeScript E2Eテスト (Phase B2-F2移行完了)
```
...
- **C# プロジェクト**: Contracts.Unit.Tests, Infrastructure.Unit.Tests, Infrastructure.Integration.Tests, Web.UI.Tests
- **TypeScript プロジェクト**: E2E.Tests（Playwright Test Generator Agent活用のため・Phase B2-F2移行完了）
